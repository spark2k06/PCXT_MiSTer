...
module ega_pixel (
    ...
    localparam [1:0] RENDER_PACKED_2BPP   = 2'd2;
    ...
    // EGA packed 2bpp compatibility fetches pack adjacent pixels across
    ...
    wire       packed_2bpp_render = (render_mode == RENDER_PACKED_2BPP);
    wire [7:0] input_plane0 = packed_2bpp_render ? {egaremap2bpp(plane0_data), egaremap2bpp(plane1_data)} : plane0_data;
    wire [7:0] input_plane1 = packed_2bpp_render ? {egaremap2bpp({1'b0, plane0_data[7:1]}), egaremap2bpp({1'b0, plane1_data[7:1]})} : plane1_data;
    wire [7:0] input_plane2 = packed_2bpp_render ? {egaremap2bpp(plane2_data), egaremap2bpp(plane3_data)} : plane2_data;
    wire [7:0] input_plane3 = packed_2bpp_render ? {egaremap2bpp({1'b0, plane2_data[7:1]}), egaremap2bpp({1'b0, plane3_data[7:1]})} : plane3_data;
    ...
    wire       graphics_render = (render_mode == RENDER_PLANAR) || (render_mode == RENDER_PACKED_2BPP);
